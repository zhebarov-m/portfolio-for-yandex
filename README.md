# Моё портфолио на базе: React + TypeScript + Vite

Проект я делал в основном как тестовое задание для приема на работу в Яндекс.Практикум. Дедлайн был 3 дня.
Основные технологии, которые были задействованы:
<div align=center>
